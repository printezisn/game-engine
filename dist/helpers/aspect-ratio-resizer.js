const resize = (container, canvas, desiredWidth, desiredHeight) => {
    ...
    const scale = Math.min(containerWidth / desiredWidth, containerHeight / desiredHeight);
    ...
    const orientation = desiredWidth < desiredHeight ? 'portrait' : 'landscape';
    return {
        width: desiredWidth,
