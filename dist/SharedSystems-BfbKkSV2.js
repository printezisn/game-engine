...
const pe = class A extends We {
  ...
  static from(e) {
    ...
    let a, i;
    return t && (a = te.from(t)), r && (i = re.from(r)), new A({
      gpuProgram: a,
      glProgram: i,
      ...n
    });
...
class it extends st {
  constructor(e) {
    const { sprite: t, ...r } = e, n = new Ve(t.texture), a = new se({
...
const O = class me {
  constructor(e, t) {
    var r, n;
    this.state = fe.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, (n = (r = this._adaptor).init) == null || n.call(r, this);
  }
  static getBatcher(e) {
  ...
  buildStart(e) {
    ...
    t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default || (t.default = new ne())), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
...
let ge = O;
E.handleByMap(d.Batcher, ge._availableBatchers);
E.add(ne);
const Dt = {
  name: "texture-bit",
  vertex: {
...
function ot(s, e) {
  ...
  a.batch.buildStart(r), a.blendMode.buildStart(), a.colorMask.buildStart(), t.sortableChildren && t.sortChildren(), ve(t, r, n, !0), a.batch.buildEnd(r), a.blendMode.buildEnd(r);
}
function P(s, e, t) {
  const r = t.renderPipes ? t : t.batch.renderer;
  s.globalDisplayStatus < 7 || !s.includeInBuild || (s.sortableChildren && s.sortChildren(), s.isSimple ? lt(s, e, r) : ve(s, e, r, !1));
}
function lt(s, e, t) {
  if (s.renderPipeId) {
  ...
  if (!r && s.renderGroup)
    ...
    if (l.length)
      for (let u = 0; u < l.length; u++)
        P(l[u], e, t);
    for (let u = s.effects.length - 1; u >= 0; u--) {
      const c = s.effects[u];
      n[c.pipe].pop(c, s, e);
    }
  }
  ...
  execute(e) {
    ...
    if (e.action === "pushMaskBegin") {
      ...
      if (n.inverse = e.inverse, r) {
        ...
        const a = je(e.mask.mask, !0, ut);
        e.mask.mask.measurable = !1, a.ceil();
        const i = t.renderTarget.renderTarget.colorTexture.source, o = J.getOptimalTexture(
          a.width,
          a.height,
          i._resolution,
          i.antialias
      ...
      r && J.returnTexture(n.filterTexture), b.return(n.filterEffect);
    }
  }
  destroy() {
...
class be {
  ...
  push(e, t, r) {
    ...
    const u = r.instructionSize - l.instructionsStart - 1;
...
function Ft(s, e) {
  for (const t in s.attributes) {
    ...
    n ? (r.format ?? (r.format = n.format), r.offset ?? (r.offset = n.offset), r.instance ?? (r.instance = n.instance)) : oe(`Attribute ${t} is not present in the shader, but is present in the geometry. Unable to infer attribute details.`);
  }
  ct(s);
}
function ct(s) {
  ...
  for (const a in t) {
    const i = t[a];
    r[i.buffer.uid] += $(i.format).stride;
  }
  for (const a in t) {
    const i = t[a];
    i.stride ?? (i.stride = r[i.buffer.uid]), i.start ?? (i.start = n[i.buffer.uid]), n[i.buffer.uid] += $(i.format).stride;
  }
}
const x = [];
x[f.NONE] = void 0;
...
const Te = class ke {
   ...
   */
  constructor(e = {}) {
    if (this.uid = C("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = !1, this._size = new Float32Array(2), this._managedColorTextures = !1, e = { ...ke.defaultOptions, ...e }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
    ...
    this.colorTexture.source.on("resize", this.onSourceResize, this), (e.depthStencilTexture || this.stencil) && (e.depthStencilTexture instanceof m || e.depthStencilTexture instanceof y ? this.depthStencilTexture = e.depthStencilTexture.source : this.ensureDepthStencilTexture());
  }
  get size() {
    const e = this._size;
...
class Wt {
  constructor(e) {
    this.rootViewPort = new S(), this.viewport = new S(), this.onRenderTargetChange = new qe("onRenderTargetChange"), this.projectionMatrix = new g(), this.defaultClearColor = [0, 0, 0, 0], this._renderSurfaceToRenderTargetHash = /* @__PURE__ */ new Map(), this._gpuRenderTargetHash = /* @__PURE__ */ Object.create(null), this._renderTargetStack = [], this._renderer = e, e.renderableGC.addManagedHash(this, "_gpuRenderTargetHash");
  }
  ...
  bind(e, t = !0, r, n) {
    ...
    const l = a.colorTexture, u = this.viewport, c = l.pixelWidth, h = l.pixelHeight;
    if (!n && e instanceof m && (n = e.frame), n) {
      const p = l._resolution;
      u.x = n.x * p + 0.5 | 0, u.y = n.y * p + 0.5 | 0, u.width = n.width * p + 0.5 | 0, u.height = n.height * p + 0.5 | 0;
    } else
    ...
    return ft(
      ...
      !a.isRoot
    ), this.adaptor.startRenderPass(a, t, r, u), i && this.onRenderTargetChange.emit(a), a;
  }
  clear(e, t = B.ALL, r) {
  ...
  _initRenderTarget(e) {
    let t = null;
    return U.test(e) && (e = ye(e).source), e instanceof I ? t = e : e instanceof y && (t = new I({
      colorTextures: [e]
...
class Se {
  ...
  execute(e) {
    ...
    }), Ce(e, this._renderer.renderPipes), this._renderer.globalUniforms.pop());
  }
  destroy() {
    this._renderer = null;
  }
...
function we(s, e = []) {
  ...
  for (let t = 0; t < s.renderGroupChildren.length; t++)
    we(s.renderGroupChildren[t], e);
  return e;
}
function mt(s, e, t) {
  const r = s >> 16 & 255, n = s >> 8 & 255, a = s & 255, i = e >> 16 & 255, o = e >> 8 & 255, l = e & 255, u = r + (i - r) * t, c = n + (o - n) * t, h = a + (l - a) * t;
  return (u << 16) + (c << 8) + h;
}
const R = 16777215;
function Pe(s, e) {
...
function Re(s, e = !1) {
  ...
  for (const n in t) {
    ...
    for (let u = 0; u < l; u++) {
      const c = o[u];
      c.parentRenderGroup === s && c.relativeRenderGroupDepth === a && Ge(c, r, 0);
    }
    F(o, l), i.index = 0;
  }
  if (e)
    for (let n = 0; n < s.renderGroupChildren.length; n++)
      Re(s.renderGroupChildren[n], e);
}
function vt(s) {
  const e = s.root;
  let t;
...
function Ge(s, e, t) {
  ...
  ), t & Q && Z(s, n, t)) : (t = s._updateFlags, s.relativeGroupTransform.copyFrom(r), t & Q && Z(s, gt, t)), !s.renderGroup) {
...
function Z(s, e, t) {
  ...
  t & ue && (s.groupBlendMode = s.localBlendMode === "inherit" ? e.groupBlendMode : s.localBlendMode), t & de && (s.globalDisplayStatus = s.localDisplayStatus & e.globalDisplayStatus), s._updateFlags = 0;
}
function xt(s, e) {
...
class Be {
  ...
  render({ container: e, transform: t }) {
    ...
    const a = this._renderer, i = we(e.renderGroup, []);
    let o = _t;
    t && (o = o.copyFrom(e.renderGroup.localTransform), e.renderGroup.localTransform.copyFrom(t));
    const l = a.renderPipes;
    for (let u = 0; u < i.length; u++) {
      const c = i[u];
      c.runOnRender(), c.instructionSet.renderPipes = l, c.structureDidChange ? F(c.childrenRenderablesToUpdate.list, 0) : xt(c, l), Re(c), c.structureDidChange ? (c.structureDidChange = !1, ot(c, a)) : bt(c), c.childrenRenderablesToUpdate.index = 0, a.renderPipes.batch.upload(c.instructionSet);
    }
    ...
    }), Ce(e.renderGroup, l), l.uniformBatch && l.uniformBatch.renderEnd(), t && e.renderGroup.localTransform.copyFrom(o), e.parent = r, e.renderGroup.renderGroupParent = n;
  }
  destroy() {
    this._renderer = null;
  }
...
const H = class Ae {
   ...
   */
  init(e) {
    e = { ...Ae.defaultOptions, ...e }, this.clearBeforeRender = e.clearBeforeRender, this.color = e.background || e.backgroundColor || this._backgroundColor, this.alpha = e.backgroundAlpha, this._backgroundColor.setAlpha(e.backgroundAlpha);
  }
...
class Ie {
  ...
  setBlendMode(e, t, r) {
    ...
    this._activeBlendMode = t, this._isAdvanced && this._endAdvancedBlendMode(r), this._isAdvanced = !!T[t], this._isAdvanced && (this._beginAdvancedBlendMode(r), this._renderableList.push(e));
  }
  _beginAdvancedBlendMode(e) {
    this._renderer.renderPipes.batch.break(e);
    const t = this._activeBlendMode;
    if (!T[t]) {
      oe(`Unable to assign BlendMode: '${t}'. You may want to include: import 'pixi.js/advanced-blend-modes'`);
      return;
    }
    let r = this._filterHash[t];
    r || (r = this._filterHash[t] = new ie(), r.filters = [new T[t]()]);
    const n = {
      renderPipeId: "filter",
      action: "pushFilter",
      renderables: [],
...
const kt = new S(), Mt = new ae(), Ct = [0, 0, 0, 0];
class De {
  constructor(e) {
    this._renderer = e;
  }
  ...
  generateTexture(e) {
    ...
    let a = e.clearColor;
    a ? a = Array.isArray(a) && a.length === 4 ? a : ce.shared.setValue(a).toArray() : a = Ct;
    const i = ((u = e.frame) == null ? void 0 : u.copyTo(kt)) || Ye(n, Mt).rectangle;
...
class Oe {
  ...
  bind({
    ...
    let h;
    this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(u, !1) : (h = this._bindGroupPool.pop() || new Xe(), this._activeBindGroups.push(h), h.setResource(u, 0)), l.bindGroup = h, this._currentGlobalUniformData = l;
  }
  push(e) {
...
class Fe {
  ...
  init() {
    K.system.add(this._update, this);
  }
  /**
   ...
   */
  destroy() {
    K.system.remove(this._update, this), this._tasks.length = 0;
  }
}
Fe.extension = {
  type: [
...
function wt(s) {
  if (!ee) {
    if (he.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
      const e = [
        `%c  %c  %c  %c  %c PixiJS %c v${Y} (${s}) http://www.pixijs.com/
...
`,
    ...
    } else globalThis.console && globalThis.console.log(`PixiJS ${Y} - ${s} - http://www.pixijs.com/`);
    ee = !0;
  }
}
class W {
...
const V = class He {
  ...
  run() {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      const l = o.renderGroup ?? o.parentRenderGroup, u = ((a = l == null ? void 0 : l.instructionSet) == null ? void 0 : a.tick) ?? -1;
      o._lastInstructionTick !== u && e - o._lastUsed > this.maxUnusedTime ? (o.destroyed || r[o.renderPipeId].destroyRenderable(o), o._lastInstructionTick = -1, n++, o.off("destroyed", this._removeRenderable, this)) : t[i - n] = o;
    }
    t.length = t.length - n;
  }
  destroy() {
...
const j = class Le {
  ...
  init(e) {
    e = { ...Le.defaultOptions, ...e }, this.checkCountMax = e.textureGCCheckCountMax, this.maxIdle = e.textureGCAMaxIdle ?? e.textureGCMaxIdle, this.active = e.textureGCActive;
  }
  /**
...
const N = class ze {
  ...
  init(e) {
    e = {
      ...ze.defaultOptions,
      ...e
    }, e.view && (Qe(Ze, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new S(0, 0, e.width, e.height), this.canvas = e.canvas || he.get().createCanvas(), this.antialias = !!e.antialias, this.texture = ye(this.canvas, e), this.renderTarget = new I({
