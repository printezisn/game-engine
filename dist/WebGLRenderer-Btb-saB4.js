import { E as l, B as A, w as m, D as S, K as j, a2 as xe, v as Ae, u as G, a as p, T as K, S as g, O as L, j as B, k as Be, l as U, s as $, M as z, a3 as Y, a4 as Ne, a5 as Ie, a6 as q, a7 as De, e as x, A as ye, R as Ce } from "./index-DigXVoxt.js";
import { S as O, b as Z } from "./colorToUniform-D3h9cD5N.js";
import { e as Ge, G as Ue, c as Oe, b as Pe, U as Fe, R as Me, B as Q, d as N, f as Le, S as He, a as we } from "./SharedSystems-BfbKkSV2.js";
class J {
  constructor() {
...
class ee {
  ...
  createGLBuffer(e) {
    ...
    e.descriptor.usage & A.INDEX ? s = T.ELEMENT_ARRAY_BUFFER : e.descriptor.usage & A.UNIFORM && (s = T.UNIFORM_BUFFER);
...
class Ze {
  ...
  postrender(e) {
    if (this._renderer.context.multiView && Be.test(e.colorTexture.resource)) {
...
const Dt = [
  ...
  oe,
  ie
], yt = [...we], Ct = [J, pe, Se], ge = [], Re = [], ve = [];
x.handleByNamedList(l.WebGLSystem, ge);
x.handleByNamedList(l.WebGLPipes, Re);
x.handleByNamedList(l.WebGLPipesAdaptor, ve);
x.add(...Dt, ...yt, ...Ct);
class Pt extends ye {
  constructor() {
    const e = {
